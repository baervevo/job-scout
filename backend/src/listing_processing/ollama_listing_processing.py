...
async def process_listings(listings: List[Listing]) -> List[ProcessedListing]:
    """
    ...
    for listing in listings:
        processed_listing = await process_listing_with_ollama(listing)
        processed_listings.append(processed_listing)

    return processed_listings


async def process_listing_with_ollama(listing: Listing) -> ProcessedListing:
    """
